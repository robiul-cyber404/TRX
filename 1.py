...
for xd in range(10000):
    ...
    ugen.append(uaku2)
try:
    os.system('https://github.com/robiul-cyber404/TRX/blob/main/appro.txt')
except:
    pass
...
def uaku2():
    try:
        ...
        a=requests.get('https://github.com/robiul-cyber404/TRX/blob/main/appro.txt').text
